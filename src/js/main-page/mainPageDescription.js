const mainPageDescription = [
    {
        ...
        class: 'main-page__item-main',
    },
    {
        header: 'Sprint',
        logoSrc: './img/cheetah.svg',
        infoSrc: './img/info.svg',
        description: 'Учит быстро переводить с английского на русский.',
        class: 'main-page__item-sprint',
    },
    {
        header: 'Аудиовызов',
        logoSrc: './img/rattle.svg',
        infoSrc: './img/info.svg',
        description: 'Улучшает восприятие английской речи на слух.',
        class: 'main-page__item-audio',
    },
    {
        header: 'English puzzle',
        logoSrc: './img/puzzle.svg',
        infoSrc: './img/info.svg',
        description: 'Помогает научиться строить предложения на английском языке.',
    ...
    },
    {
        ...
        infoSrc: './img/info.svg',
        description: 'Помогает научиться правильно произносить слова.',
...
export { mainPageDescription as default };
