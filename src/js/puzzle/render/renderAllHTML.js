export default function renderAllHTML() {
  ...
  PUZZLE.innerHTML = `<div class="puzzle-wrapper">
    ...
    <section class="puzzle-main-page hide">
      <div class="puzzle-main-page__bar">
        ...
        <div class="puzzle-main-page__buttons">
      ...
      <div class="puzzle-main-page__translate">
        <p class="text-translate"></p>
        <audio type="audio/mpeg"></audio>
      </div>      

      <div class="puzzle-main-page__puzzle"></div>    
      
      <div class="puzzle-main-page__current">
